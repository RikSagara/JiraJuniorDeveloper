...
public class StoryControllerTest {
    ...
    @Test
    public void testStoryForm() throws Exception {
        UserListForm userListForm=new UserListForm();
        userListForm.setUsers(users.findAllUsers());
        mockMvc.perform(
                MockMvcRequestBuilders.get("/addStory").session(session)
        ).andExpect(status().isOk())
                .andExpect(view().name("/StoryPages/createStory"))
    ...
    public void PostStoryFormTest() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.post("/addStory")
                        .session(session)
                ...
                .andExpect(view().name("redirect:/stories"))
                .andReturn();
    }
